...
public class SendNotificationBeforeClassJobConfig {
    ...
    public SendNotificationBeforeClassJobConfig(SendNotificationItemWriter sendNotificationItemWriter) {
        this.sendNotificationItemWriter = sendNotificationItemWriter;
    }


    @Bean
    public Job sendNotificationBeforeClassJob(JobRepository jobRepository, PlatformTransactionManager transactionManager, EntityManagerFactory entityManagerFactory) {
        return new JobBuilder("sendNotificationBeforeClassJob", jobRepository)
                .start(addNotificationStep(jobRepository, transactionManager, entityManagerFactory))
                .next(sendNotificationStep(jobRepository, transactionManager, entityManagerFactory))
                .build();
    }

    @Bean
    public Step addNotificationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager, EntityManagerFactory entityManagerFactory) {
        return new StepBuilder("addNotificationStep", jobRepository)
                ...
                .reader(addNotificationItemReader(entityManagerFactory))
                .processor(addNotificationItemProcessor())
                .writer(addNotificationItemWriter(entityManagerFactory))
                .build();
     ...
     */
    @Bean
    public JpaPagingItemReader<BookingEntity> addNotificationItemReader(EntityManagerFactory entityManagerFactory) {
    ...
    @Bean
    public JpaItemWriter<NotificationEntity> addNotificationItemWriter(EntityManagerFactory entityManagerFactory) {
     ...
     */
    @Bean
    public Step sendNotificationStep(JobRepository jobRepository, PlatformTransactionManager transactionManager, EntityManagerFactory entityManagerFactory) {
        return new StepBuilder("sendNotificationStep", jobRepository)
                ...
                .reader(sendNotificationItemReader(entityManagerFactory))
     ...
     */
    @Bean
    public SynchronizedItemStreamReader<NotificationEntity> sendNotificationItemReader(EntityManagerFactory entityManagerFactory) {
